...
1. **aixlarity-core must stay dependency-light.** Every new dependency needs justification.
...
2. Does this add a new dependency to aixlarity-core? If yes, is it justified?
