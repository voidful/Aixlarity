...
const files = {
	...
	welcomeContent: path.join(root, 'src/vs/workbench/contrib/welcomeGettingStarted/common/gettingStartedContent.ts'),
	welcomeContribution: path.join(root, 'src/vs/workbench/contrib/welcomeGettingStarted/browser/gettingStarted.contribution.ts'),
...
const checks = [
	...
	},
	{
		...
		patterns: [
			'openProviderSetup',
			'applyPendingProviderSetupIntent',
			'data-aixlarity-add-api-key',
			'providerSwitchScope',
			'Provider Preset',
	...
	{
		name: 'First-run routes users to provider setup instead of sign-in',
		file: 'welcomeContent',
		patterns: [
	...
	{
		name: 'First-run does not show account onboarding as the primary path',
		file: 'welcomeContribution',
		patterns: [
			'workbench.welcomePage.experimentalOnboarding',
			'Aixlarity starts with local provider setup',
			'default: false',
		],
	},
	{
		name: 'Provider setup commands open the Aixlarity sidebar',
		file: 'contribution',
		patterns: [
			'aixlarity.chooseProvider',
			'aixlarity.addApiKey',
			'aixlarity.selectModel',
			'openAixlarityProviderSetup',
			'choose-provider',
			'add-api-key',
			'select-model',
		],
