...
// Chat (Restored to prevent taskService/terminalChat dependency crashes)
...
// Aixlarity Agent
import './contrib/aixlarity/browser/aixlarity.contribution.js';
...
// Surveys (Disabled via UI now)
import './contrib/surveys/browser/nps.contribution.js';
import './contrib/surveys/browser/languageSurveys.contribution.js';

// Welcome (Disabled via UI now)
...
// Welcome Onboarding (Disabled via UI now)
